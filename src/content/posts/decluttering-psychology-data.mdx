...
## Decluttering psychology books beyond KonMari

If KonMari didn't stick, these three books cover the decluttering decision tree from different philosophical angles. Each has a distinct framework — read whichever maps to your hesitation pattern:

<ProductBox
  name="Goodbye, Things (Fumio Sasaki)"
  priceHint="$12-18 — Japanese ultra-minimalism manifesto"
  pros={[
  ...
  href="https://www.amazon.com/s?k=Goodbye+Things+Fumio+Sasaki"
  region="us"
/>

<ProductBox
  name="The More of Less (Joshua Becker)"
  priceHint="$15-22 — family-friendly minimalism"
  pros={[
  ...
  href="https://www.amazon.com/s?k=More+of+Less+Joshua+Becker"
  region="us"
/>

<ProductBox
  name="Essentialism (Greg McKeown)"
  priceHint="$15-22 — minimalism applied to time and attention"
  pros={[
  ...
  href="https://www.amazon.com/s?k=Essentialism+Greg+McKeown"
  region="us"
/>

For physical-clutter focus, Sasaki + Becker is the strongest pair. Add McKeown if your real problem is over-committed time, not over-stuffed closets.
